...
CREATE TABLE IF NOT EXISTS DAW212DBProyectoTema5.T02_Departamento(
...
CREATE TABLE IF NOT EXISTS DAW212DBProyectoTema5.T01_Usuario(
...
CREATE USER 'usuarioDAW212DBProyectoTema5'@'%' IDENTIFIED BY 'paso';
